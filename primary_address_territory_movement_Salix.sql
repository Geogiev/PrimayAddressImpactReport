...
/****** Object:  View [dbo].[primary_address_territory_movement_Salix]    Script Date: 12/16/2019 12:49:43 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE view [dbo].[primary_address_territory_movement_Salix] as select
	a1.*,
	b1.*,
	v2.*,
	c.*,
