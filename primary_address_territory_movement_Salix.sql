...
/****** Object:  View [dbo].[primary_address_territory_movement_Salix]    Script Date: 12/16/2019 1:38:55 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER view [dbo].[primary_address_territory_movement_Salix] as 
with Old_addr as(
select
	b.Name user_profile_old,
	b.createddate createddate_old,
	b.parentid parentid_old,
	a.Primary_Address_Salix__c PRIMARY_VOD__C_old,
...
select
	...
	a.Primary_Address_Salix__c PRIMARY_VOD__C_new,
...
from
	...
	where
		...
		'System Administrator',
		'Bauschhealth - Sales Operations')
		and a.field in ('Primary_Address_Salix__c')
...
select
	...
	null parentid_curr,
	c.Primary_Address_Salix__c PRIMARY_VOD__C_curr,
	...
	d.team Team_Curr
from
	[Veeva_Replication].[db_owner].[SF_ADDRESS_VOD__C] c
left outer join [Data_Quality_Reporting].[dbo].[ZipTerr_V1] d on
...
left join V2 on
	New_addr2.ACCOUNT_VOD__C_new = v2.DS_SFID_V1
